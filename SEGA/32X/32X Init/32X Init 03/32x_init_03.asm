;----------------------------------------------------
;32x ASM Project 0.3 - 68000 - 2022.01.16
...
romSize equ (romEnd-$880001)
  ...
  dc.b "SEGA 32X COMPILATION/INITIALIZATION TEST 03     ";            $0120
                            ;Domestic name, 48 characters
  dc.b "SEGA 32X COMPILATION/INITIALIZATION TEST 03     ";            $0150
  ...
  dc.b "FUN WITH DMA                            ";Notes, 40 char.     $01c8
  ...
  ;Padding
  dcb.b $8803c0-*,0
  dc.b "32X INIT TEST 03"   ;32X header 16 bytes                $03c0-$03cf
...
sh2Master:
  incbin "32x_init_03_sh2_master.bin"
sh2Slave:
  incbin "32x_init_03_sh2_slave.bin"
z80Code:
  incbin "32x_init_03_z80.bin"
