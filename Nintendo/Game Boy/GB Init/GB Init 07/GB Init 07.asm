;----------------------------------------------------
;GameBoy ASM Project 0.7 - 2020.11.05
;The Window Register, and mutiple HBlanks
;by Saad Azim
;----------------------------------------------------
...
cpu gbz80
  ...
  db "GB INIT 0.7    "      ;Game Title 15 bytes                                    $0134-$0142
...
loopClearHRAM:
  ...
  ;Copy VBlank & LCDStat01 (HBlank) code to RAM
  ld hl,VBlankJump
...
loopCopyTileMap:
  ...
  ld a,%11110001            ;Modified to display window, using window map starting at $9C00
       ;|:|:|:|:
       ;|:|:|:|Enable BG (and Window) (off||on)
       ;|:|:|:Enable Sprite (off||on)
       ;|:|:|Sprite Size (8x8||8x16)
...
bootInit:
  ...
  db $40,$44                ;Initialize line counter to trigger LCDStat01 (HBlank) at line $44
