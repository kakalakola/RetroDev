;----------------------------------------------------
;GameBoy ASM Project 0.8 - 2020.11.06
...
_SPRITE_01_DATA:     equ $c104 ;Start of attributes for sprite 01...
_SPRITE_02_DATA:     equ $c108
_SPRITE_03_DATA:     equ $c10c
...
cpu gbz80
  ...
  db "GB INIT 0.8    "      ;Game Title 15 bytes                                    $0134-$0142
...
loopCopyDMARoutine:
  ...
  ld hl,sprites             ;Source
  ld b,$10                  ;4 sprites, 4 bytes per sprite
  ld de,_SPRITE_DATA        ;Destination
loopCopySpriteData:
  ldi a,(hl)
  ld (de),a
  inc de
...
checkRight:
  ...
  ;Update sprite X position to move with background. The movement of the sprites have to be the opposite of the movement of the background. i.e if the X scroll for the background is increased by 1, the X scroll of the sprites need to be decreased by 1.
  ...
  ;Update sprite 0 X flip
  ld a,(_SPRITE_DATA+3)
  res 5,a                   ;Reset bit 5 to disable X axis flip
  ld (_SPRITE_DATA+3),a
...
checkLeft:
  ...
  ;Update sprite 0 X flip
  ld a,(_SPRITE_DATA+3)
  set 5,a                   ;Set bit 5 to enable X axis flip
  ld (_SPRITE_DATA+3),a
...
loopCopyTileMap:
  ...
  ld a,%11110011            ;Modified to display sprites
       ;|:|:|:|:
       ;|:|:|:|Enable BG (and Window) (off||on)
       ;|:|:|:Enable Sprite (off||on)
       ;|:|:|Sprite Size (8x8||8x16)
...
sprites:
  ...
  db $58, $58,  $06, %00000000 ;E, using palette 0

  db $43, $47,  $06, %00010000 ;E, using palette 1
  db $69, $45,  $07, %00010000 ;F, using palette 1
  db $48, $6a,  $07, %00110000 ;F, using palette 1, X flip
